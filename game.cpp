...
int Game::takeIntegerInput() {
 ...
 bool Game::validateSelected Players (int index){
...
void Game::tossChoice(Team tossWinnerTeam) {
	...
	switch (tossInput) {
		case 1:
			...
			break;
		case 2:
			cout << endl << tossWinnerTeam.name << " won the toss and choose to bowl first" << endl <<;
		...
		void tossChoice("tossWinnerTeam");
			break;
   	}
}
...
bool Game::validate InningsScore() {
